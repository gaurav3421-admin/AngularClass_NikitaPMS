...
@Component({
  selector: 'app-deleteproduct-details',
  imports: [CommonModule, FormsModule],
  templateUrl: './deleteproduct-details.html',
  styleUrl: './deleteproduct-details.css',
})
    ...
    deleteProductDetails(deleteProductForm: NgForm): void {
      ...
      if (deleteProductForm.valid){
          console.log("Deleting product with ID:", this.product.id);
            this.commonService.deleteProductDetails(this.product.id).subscribe(
                (response) => {
